...
<div class="login-container">
    <div class="card">
        <i class="fas fa-building icon"></i> <!-- Font Awesome Building Icon -->
        <h2 class="mb-4">{{ __('Login to Your Institution Account') }}</h2>
        ...
        <form method="POST" action="{{ route('institution.login') }}">
            ...
            <div class="form-group mb-3">
                <label for="email" class="form-label">{{ __('Email') }}</label><br><br>
                <input type="email" name="email" class="form-control" required autofocus>
            </div>

            <!-- Password -->
            <div class="form-group mb-3">
                <label for="password" class="form-label">{{ __('Password') }}</label><br><br>
        ...
        <div class="additional-links">
            <a href="{{ route('institution.register') }}">{{ __('Don\'t have an account? Register here') }}</a><br>
